const CTAs = ({ data }) => {
    return (
        <section className="schools-ctas" style={{ backgroundImage: `url(${data.image})` }}>
            <div className="container">
                <h2 className="bigger text-hei-blue text-center mx-auto max-w-[773px] mb-[40px]">{data.title}</h2>
